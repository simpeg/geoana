...
# @cython.ufunc
# @cython.cdivision
# cdef double prism_f(double x, double y, double z) nogil:
...
@cython.cdivision
cdef api double c_prism_fz(double x, double y, double z) nogil:
    ...
    return v
def prism_fz(x, y, z):
    cdef double[:] x_, y_, z_, out_
    out = np.empty_like(x)

    x_ = np.asarray(x).ravel()
    y_ = np.asarray(y).ravel()
    z_ = np.asarray(z).ravel()
    out_ = np.asarray(out).ravel()

    cdef int i
    for i in range(x_.shape[0]):
        out_[i] = c_prism_fz(x_[i], y_[i], z_[i])
    return out
...
# @cython.ufunc
# @cython.cdivision
# cdef double prism_fzz(double x, double y, double z) nogil:
...
# @cython.ufunc
# @cython.cdivision
# cdef double prism_fzx(double x, double y, double z) nogil:
...
# @cython.ufunc
# @cython.cdivision
# cdef double prism_fzy(double x, double y, double z) nogil:
...
# @cython.ufunc
# @cython.cdivision
# cdef double prism_fzzz(double x, double y, double z) nogil:
...
# @cython.ufunc
# @cython.cdivision
# cdef double prism_fxxy(double x, double y, double z) nogil:
...
# @cython.ufunc
# @cython.cdivision
# cdef double prism_fxxz(double x, double y, double z) nogil:
...
# @cython.ufunc
# @cython.cdivision
# cdef double prism_fxyz(double x, double y, double z) nogil:
